		...
		for key, row in self.voucher_balance.items():
			...
			if must_consider:
				...
				if self.is_invoice(row) and self.filters.based_on_payment_terms:
					...
					self.append_row(row)
					output_data.append(row)
		if self.filters.get("party_account"):
			pass
		else:
			query_filters = []
			...
			if self.filters.get("party"):
				query_filters.append(["customer", "in", self.filters.get("party")])
			...
			if doc:
				for i in doc:
					sales_doc = frappe.get_doc("Sales Order", i.get("name"))
					today = datetime.today().date()
					transaction_date = sales_doc.transaction_date or today  # Use today's date if transaction_date is not set
					delivery_date = sales_doc.delivery_date or today  # Use today's date if delivery_date is not set

					# Calculate age based on transaction date
					age = (today - transaction_date).days

					# Calculate aging values based on age
					if age <= self.filters.get("range1"):
						range1 = sales_doc.grand_total
						range2 = range3 = range4 = range5 = 0.0
						sales_order_data = {'voucher_type': 'Sales Order', 'voucher_no': sales_doc.name, 'party': sales_doc.customer, 'party_account': '', 'posting_date': sales_doc.transaction_date, 'account_currency':sales_doc.currency , 'remarks': None, 'invoiced': sales_doc.grand_total, 'paid': 0.0, 'credit_note': 0.0, 'outstanding': sales_doc.grand_total, 'invoiced_in_account_currency': sales_doc.grand_total, 'paid_in_account_currency': 0.0, 'credit_note_in_account_currency': 0.0, 'outstanding_in_account_currency': sales_doc.grand_total, 'party_type': 'Customer', 'invoice_grand_total': sales_doc.grand_total, 'name': sales_doc.name, 'due_date': sales_doc.delivery_date, 'po_no': '', 'customer_name': sales_doc.customer_name, 'territory': sales_doc.territory, 'customer_group': sales_doc.customer_group, 'customer_primary_contact': None, 'currency': sales_doc.currency, 'range1': range1, 'range2': range2, 'range3': range3, 'range4': range4, 'range5': range5, 'age': age, 'total_due': sales_doc.grand_total, "sales_person":sales_doc.employee}
						self.data.append(sales_order_data)
					elif age <= self.filters.get("range2"):
						range1 = 0.0
						range2 = sales_doc.grand_total
						range3 = range4 = range5 = 0.0
						sales_order_data = {'voucher_type': 'Sales Order', 'voucher_no': sales_doc.name, 'party': sales_doc.customer, 'party_account': '', 'posting_date': sales_doc.transaction_date, 'account_currency':sales_doc.currency , 'remarks': None, 'invoiced': sales_doc.grand_total, 'paid': 0.0, 'credit_note': 0.0, 'outstanding': sales_doc.grand_total, 'invoiced_in_account_currency': sales_doc.grand_total, 'paid_in_account_currency': 0.0, 'credit_note_in_account_currency': 0.0, 'outstanding_in_account_currency': sales_doc.grand_total, 'party_type': 'Customer', 'invoice_grand_total': sales_doc.grand_total, 'name': sales_doc.name, 'due_date': sales_doc.delivery_date, 'po_no': '', 'customer_name': sales_doc.customer_name, 'territory': sales_doc.territory, 'customer_group': sales_doc.customer_group, 'customer_primary_contact': None, 'currency': sales_doc.currency, 'range1': range1, 'range2': range2, 'range3': range3, 'range4': range4, 'range5': range5, 'age': age, 'total_due': sales_doc.grand_total, "sales_person":sales_doc.employee}
						self.data.append(sales_order_data)
					elif age <= self.filters.get("range3"):
						range1 = range2 = 0.0
						range3 = sales_doc.grand_total
						range4 = range5 = 0.0
						sales_order_data = {'voucher_type': 'Sales Order', 'voucher_no': sales_doc.name, 'party': sales_doc.customer, 'party_account': '', 'posting_date': sales_doc.transaction_date, 'account_currency':sales_doc.currency , 'remarks': None, 'invoiced': sales_doc.grand_total, 'paid': 0.0, 'credit_note': 0.0, 'outstanding': sales_doc.grand_total, 'invoiced_in_account_currency': sales_doc.grand_total, 'paid_in_account_currency': 0.0, 'credit_note_in_account_currency': 0.0, 'outstanding_in_account_currency': sales_doc.grand_total, 'party_type': 'Customer', 'invoice_grand_total': sales_doc.grand_total, 'name': sales_doc.name, 'due_date': sales_doc.delivery_date, 'po_no': '', 'customer_name': sales_doc.customer_name, 'territory': sales_doc.territory, 'customer_group': sales_doc.customer_group, 'customer_primary_contact': None, 'currency': sales_doc.currency, 'range1': range1, 'range2': range2, 'range3': range3, 'range4': range4, 'range5': range5, 'age': age, 'total_due': sales_doc.grand_total, "sales_person":sales_doc.employee}
						self.data.append(sales_order_data)
					elif age <= self.filters.get("range4"):
						range1 = range2 = range3 = 0.0
						range4 = sales_doc.grand_total
						range5 = 0.0
						sales_order_data = {'voucher_type': 'Sales Order', 'voucher_no': sales_doc.name, 'party': sales_doc.customer, 'party_account': '', 'posting_date': sales_doc.transaction_date, 'account_currency':sales_doc.currency , 'remarks': None, 'invoiced': sales_doc.grand_total, 'paid': 0.0, 'credit_note': 0.0, 'outstanding': sales_doc.grand_total, 'invoiced_in_account_currency': sales_doc.grand_total, 'paid_in_account_currency': 0.0, 'credit_note_in_account_currency': 0.0, 'outstanding_in_account_currency': sales_doc.grand_total, 'party_type': 'Customer', 'invoice_grand_total': sales_doc.grand_total, 'name': sales_doc.name, 'due_date': sales_doc.delivery_date, 'po_no': '', 'customer_name': sales_doc.customer_name, 'territory': sales_doc.territory, 'customer_group': sales_doc.customer_group, 'customer_primary_contact': None, 'currency': sales_doc.currency, 'range1': range1, 'range2': range2, 'range3': range3, 'range4': range4, 'range5': range5, 'age': age, 'total_due': sales_doc.grand_total, "sales_person":sales_doc.employee}
						self.data.append(sales_order_data)
					else:
						range1 = range2 = range3 = range4 = 0.0
						range5 = sales_doc.grand_total
						sales_order_data = {'voucher_type': 'Sales Order', 'voucher_no': sales_doc.name, 'party': sales_doc.customer, 'party_account': '', 'posting_date': sales_doc.transaction_date, 'account_currency':sales_doc.currency , 'remarks': None, 'invoiced': sales_doc.grand_total, 'paid': 0.0, 'credit_note': 0.0, 'outstanding': sales_doc.grand_total, 'invoiced_in_account_currency': sales_doc.grand_total, 'paid_in_account_currency': 0.0, 'credit_note_in_account_currency': 0.0, 'outstanding_in_account_currency': sales_doc.grand_total, 'party_type': 'Customer', 'invoice_grand_total': sales_doc.grand_total, 'name': sales_doc.name, 'due_date': sales_doc.delivery_date, 'po_no': '', 'customer_name': sales_doc.customer_name, 'territory': sales_doc.territory, 'customer_group': sales_doc.customer_group, 'customer_primary_contact': None, 'currency': sales_doc.currency, 'range1': range1, 'range2': range2, 'range3': range3, 'range4': range4, 'range5': range5, 'age': age, 'total_due': sales_doc.grand_total, "sales_person":sales_doc.employee}
						self.data.append(sales_order_data)
