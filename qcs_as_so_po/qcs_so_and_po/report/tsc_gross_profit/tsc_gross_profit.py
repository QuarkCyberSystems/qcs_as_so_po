...
def execute(filters=None):
	...
	group_wise_columns = frappe._dict(
		{
			...
			"project": ["project", "base_amount", "buying_amount", "gross_profit", "gross_profit_percent", "profit_percent"],
			"territory": [
				"territory",
				"base_amount",
				"buying_amount",
	...
	final_data = []
	for i in data:
		if i['buying_amount'] != 0:
			profit_percentage = (i['gross_profit'] / i['buying_amount']) * 100
			i['profit_%'] = profit_percentage
		else:
